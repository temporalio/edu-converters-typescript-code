 ...
 *
 * We recommended using the DefaultFailureConverter instead of customizing the default implementation in order
...
export class DefaultFailureConverter implements FailureConverter {
  ...
  constructor(options?: Partial<DefaultFailureConverterOptions>) {
    ...
    this.options = {
      // TODO Part C: Set `EncodeCommonAttributes: true`.
